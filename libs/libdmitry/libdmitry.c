...
/* 
 * Adapted for Exynos5410 Platform
 */
 ...
 *
 * Problems:
 * 1. JA3G's GPS library was made to work with android L
...
{
    ALOGI("JA3G GPS interposition library loaded. Your GPS should work in M now.");
}
...
{
    ALOGI("JA3G GPS interposition library unloading. Goodbye...");
